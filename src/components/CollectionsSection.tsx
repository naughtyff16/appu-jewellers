...
const CollectionsSection = () => {
  ...
  return (
    <section id="collections" className="py-24 lg:py-32 bg-background" ref={ref}>
                ...
                <div className="transform transition-transform duration-500 group-hover:-translate-y-2">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {collection.items.map((item) => (
                      <span
                        key={item}
                        className="px-3 py-1 text-xs font-medium bg-primary/20 backdrop-blur-sm text-ivory rounded-full"
                      >
                        {item}
                      </span>
                    ))}
